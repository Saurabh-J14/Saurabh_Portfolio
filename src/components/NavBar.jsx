...
export default function NavBar() {
  ...
  return (
    <>
      <div className=" font-sans flex justify-between items-center w-full h-20 text-white px-4 bg-black fixed">
        <div>
          <h1 className="text-4xl font-signature ml-2">Saurabh</h1>
        </div>
